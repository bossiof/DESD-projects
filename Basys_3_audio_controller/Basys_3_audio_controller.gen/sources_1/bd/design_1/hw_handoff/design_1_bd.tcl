...
# module references:
# balance_controller, debouncer, debouncer, digilent_jstk2, dual_moving_average, edge_detector, edge_detector, led_controller, mute, volume
...
proc create_root_design { parentCell } {
  ...
  set block_cell_name edge_detector_2
  if { [catch {set edge_detector_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $edge_detector_2 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set block_name edge_detector
  set block_cell_name edge_detector_3
  if { [catch {set edge_detector_3 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $edge_detector_3 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: led_controller_1, and set properties
  set block_name led_controller
  set block_cell_name led_controller_1
  if { [catch {set led_controller_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $led_controller_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.LED_CHANNEL_BITS {8} \
 ] $led_controller_1

  # Create instance: mute_1, and set properties
  set block_name mute
  set block_cell_name mute_1
  if { [catch {set mute_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mute_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: volume_0, and set properties
  set block_name volume
  set block_cell_name volume_0
  if { [catch {set volume_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $volume_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_intf_net -intf_net balance_controller_0_m_axis [get_bd_intf_pins balance_controller_0/m_axis] [get_bd_intf_pins volume_0/s_axis]
  ...
  connect_bd_intf_net -intf_net mute_1_m_axis [get_bd_intf_pins axis_dual_i2s_0/s_axis] [get_bd_intf_pins mute_1/m_axis]
  connect_bd_intf_net -intf_net volume_0_m_axis [get_bd_intf_pins mute_1/s_axis] [get_bd_intf_pins volume_0/m_axis]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi4stream_spi_master_0/aclk] [get_bd_pins axis_dual_i2s_0/aclk] [get_bd_pins balance_controller_0/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins debouncer_2/clk] [get_bd_pins debouncer_3/clk] [get_bd_pins digilent_jstk2_0/aclk] [get_bd_pins dual_moving_average_0/aclk] [get_bd_pins edge_detector_2/clk] [get_bd_pins edge_detector_3/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins volume_0/aclk]
  ...
  connect_bd_net -net debouncer_2_debounced [get_bd_pins debouncer_2/debounced] [get_bd_pins edge_detector_2/input_signal]
  connect_bd_net -net debouncer_3_debounced [get_bd_pins debouncer_3/debounced] [get_bd_pins edge_detector_3/input_signal]
  connect_bd_net -net digilent_jstk2_0_btn_jstk [get_bd_pins debouncer_3/input_signal] [get_bd_pins digilent_jstk2_0/btn_jstk]
  connect_bd_net -net digilent_jstk2_0_btn_trigger [get_bd_pins debouncer_2/input_signal] [get_bd_pins digilent_jstk2_0/btn_trigger]
  connect_bd_net -net digilent_jstk2_0_jstk_x [get_bd_pins balance_controller_0/in_joystick] [get_bd_pins digilent_jstk2_0/jstk_x]
  connect_bd_net -net digilent_jstk2_0_jstk_y [get_bd_pins digilent_jstk2_0/jstk_y] [get_bd_pins volume_0/in_joystick]
  connect_bd_net -net edge_detector_2_output_signal [get_bd_pins edge_detector_2/output_signal] [get_bd_pins led_controller_1/mute_enable] [get_bd_pins mute_1/mute_enable]
  connect_bd_net -net edge_detector_3_output_signal [get_bd_pins dual_moving_average_0/filter_enable] [get_bd_pins edge_detector_3/output_signal] [get_bd_pins led_controller_1/filter_enable]
  connect_bd_net -net led_controller_1_led_b [get_bd_pins digilent_jstk2_0/led_b] [get_bd_pins led_controller_1/led_b]
  connect_bd_net -net led_controller_1_led_g [get_bd_pins digilent_jstk2_0/led_g] [get_bd_pins led_controller_1/led_g]
  connect_bd_net -net led_controller_1_led_r [get_bd_pins digilent_jstk2_0/led_r] [get_bd_pins led_controller_1/led_r]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi4stream_spi_master_0/aresetn] [get_bd_pins axis_dual_i2s_0/aresetn] [get_bd_pins balance_controller_0/areset] [get_bd_pins digilent_jstk2_0/aresetn] [get_bd_pins dual_moving_average_0/areset] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins volume_0/areset]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins debouncer_2/reset] [get_bd_pins debouncer_3/reset] [get_bd_pins edge_detector_2/reset] [get_bd_pins edge_detector_3/reset] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axis_dual_i2s_0/i2s_resetn] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
